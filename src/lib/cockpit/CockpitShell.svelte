...
<div class="lucy-v2 cockpit" data-theme={effectiveTheme} style={accentVars}>
  ...
  <div class="body">
    ...
    {:else if activeModule === 'config'}
      <div class="view-full"><CockpitConfig {model} {personality} {onSetPersonality} {onConfigureKeys} {onOpenSettings} accent={accentKey} onSetAccent={setAccent} theme={themeKey} onSetTheme={setTheme} /></div>
    {:else}
